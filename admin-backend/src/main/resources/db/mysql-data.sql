...
VALUES (1, '权限管理', '/auth', NULL, 'Lock', 0, '2024-05-06 13:46:48', '2024-05-16 04:04:36'),
       ...
       (3, '角色管理', '/auth/role', '/layout/auth/role/index.vue', 'Avatar', 1, '2024-05-06 13:46:48',
        '2024-05-06 13:46:48'),
       (4, '菜单管理', '/auth/menu', '/layout/auth/menu/index.vue', 'Menu', 1, '2024-05-06 13:46:48',
        '2024-05-06 13:46:48'),
       ...
       (7, '菜单测试-sub2', '/test/sub2', '/layout/test/sub2.vue', 'HomeFilled', 5, '2024-05-13 00:50:29',
        ...
        '2025-01-17 00:00:00'),
        (9, '接口文档', '/dev/swagger', '/layout/dev/swagger/index.vue', 'Document', 8, '2025-01-17 00:00:00',
        '2025-01-17 00:00:00'),
        (10, '日志管理', '/log', NULL, 'Management', 0, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
        (11, '登入日志', '/log/login', '/layout/log/login/index.vue', 'Checked', 10, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
        (12, '操作日志', '/log/ops', '/layout/log/ops/index.vue', 'List', 10, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
        (13, '异常日志', '/log/error', '/layout/log/error/index.vue', 'Failed', 10, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00');