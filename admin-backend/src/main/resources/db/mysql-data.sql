...
delete from `t_menu`;
INSERT INTO `t_menu`
VALUES (1, '权限管理', '/auth', NULL, 'Lock', 0, 0, 0, null, '2024-05-06 13:46:48', '2024-05-16 04:04:36'),
       (2, '用户管理', '/auth/user', '/auth/user/index.vue', 'User', 1, 0, 0, null, '2024-05-06 13:46:48',
        '2024-05-06 13:46:48'),
       (3, '角色管理', '/auth/role', '/auth/role/index.vue', 'Avatar', 1, 0, 0, null, '2024-05-06 13:46:48',
        '2024-05-06 13:46:48'),
       (4, '菜单管理', '/auth/menu', '/auth/menu/index.vue', 'Grid', 1, 0, 0, null, '2024-05-06 13:46:48',
        '2024-05-06 13:46:48'),
       (5, '菜单测试', '/test', NULL, 'Location', 0, 0, 0, null, '2024-05-13 00:50:29', '2024-05-13 00:50:29'),
       (6, '菜单测试-sub1', '/test/sub1', '/test/sub1.vue', 'Location', 5, 0, 0, null, '2024-05-13 00:50:29',
        '2024-05-13 00:50:29'),
       (7, '菜单测试-sub2', '/test/sub2', '/test/sub2.vue', 'HomeFilled', 5, 0, 0, null, '2024-05-13 00:50:29',
        '2024-05-13 00:50:29'),
       (8, '系统工具', '/tool', NULL, 'Tools', 0, 0, 0, null, '2025-01-17 00:00:00',
        '2025-01-17 00:00:00'),
       (9, '接口文档', '/tool/swagger', null, 'Document', 8, 1, 1, 'http://localhost:8080/swagger-ui/index.html', '2025-01-17 00:00:00',
        '2025-01-17 00:00:00'),
       (10, '字典管理', '/tool/dict', '/tool/dict/index.vue', 'Collection', 8, 0, 0, null, '2025-01-17 00:00:00',
        '2025-01-17 00:00:00'),
       (11, '日志管理', '/log', NULL, 'Management', 0, 0, 0, null, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
       (12, '登入日志', '/log/login', '/log/login/index.vue', 'Checked', 11, 0, 0, null, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
       (13, '操作日志', '/log/ops', '/log/ops/index.vue', 'List', 11, 0, 0, null, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00'),
       (14, '异常日志', '/log/error', '/log/error/index.vue', 'Failed', 11, 0, 0, null, '2025-01-15 00:00:00',
        '2025-01-15 00:00:00');
