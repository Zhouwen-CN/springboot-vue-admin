...
VALUES (1, '权限管理', '/auth', 'Lock', 0, 0, 0),
       (2, '用户管理', '/auth/user', 'User', 1, 0, 1),
       (3, '角色管理', '/auth/role', 'Avatar', 1, 0, 1),
       (4, '菜单管理', '/auth/menu', 'Grid', 1, 0, 1),
       (5, '系统工具', '/tool', 'Tools', 0, 0, 0),
       (6, '接口文档', '/tool/swagger', 'Document', 5, 1, 1),
